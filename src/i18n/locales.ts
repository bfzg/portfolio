...
export const messages = {
  zh: {
    ...
    "admin.skills": "技能关键词",
    "admin.techStack": "技术栈图片",
    "admin.addSkill": "添加技能",
    "admin.deleteSkill": "删除技能",
  ...
  en: {
    ...
    "admin.techStack": "Tech Stack Images",
    "admin.addSkill": "Add Skill",
    "admin.deleteSkill": "Delete Skill",
